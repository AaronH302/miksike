...
class PageThirdy extends StatefulWidget {
  const PageThirdy({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageThirdy> {
...
List<Map<String, Object>> _generateQuestions() {
  ...
  for (int i = 1; i <= 10; i++) {
    int divisor = 5; // Add 1 to ensure non-zero values
