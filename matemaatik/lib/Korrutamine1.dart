...
class PageThirdteen extends StatefulWidget {
  const PageThirdteen({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageThirdteen> {
...
List<Map<String, Object>> _generateQuestions() {
  ...
  for (int i = 1; i <= 10; i++) {
    int num1 = 1; // Add 1 to ensure non-zero values
