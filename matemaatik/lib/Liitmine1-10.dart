...
class PageFive extends StatefulWidget {
  final int limit;
  const PageFive({Key? key, required this.limit}) : super(key: key);
...
class _MyAppState extends State<PageFive> {
        ...
        children: <Widget>[
          ...
          TextButton(
            onPressed: () => Navigator.push(
              context,
              //TODO !!!!!!! PARANDA LIMIT
              MaterialPageRoute(builder: (context) => const PageFive(limit: 0,)),
            ),
            child: Container(
              color: Colors.green,
          ...
          TextButton(
            ...
            child: Container(
              ...
              padding: const EdgeInsets.all(8), //muuda neid et vahesid suurendada voi vahendada
              child: const Text(
                'Välju mängust',
                style: TextStyle(color: Color.fromARGB(255, 0, 0, 0)),
              ),
