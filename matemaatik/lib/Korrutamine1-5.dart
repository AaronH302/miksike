...
class PageTwentythree extends StatefulWidget {
  const PageTwentythree({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageTwentythree> {
...
List<Map<String, Object>> _generateQuestions() {
  ...
  for (int i = 1; i <= 10; i++) {
    int num1 = Random().nextInt(1) + 1; // Add 1 to ensure non-zero values
    int num2 = Random().nextInt(5); // Add 1 to ensure non-zero values
