...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      home: PageFourthyfour(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class PageFourthyfour extends StatefulWidget {
  const PageFourthyfour({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageFourthyfour> {
        ...
        children: <Widget>[
          ...
          TextButton(
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const PageFourthyfour()),
            ),
            child: Container(
              color: Colors.green,
