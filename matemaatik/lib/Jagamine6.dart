...
class PageThirdyone extends StatefulWidget {
  const PageThirdyone({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageThirdyone> {
...
List<Map<String, Object>> _generateQuestions() {
  ...
  for (int i = 1; i <= 10; i++) {
    int divisor = 6; // Add 1 to ensure non-zero values
