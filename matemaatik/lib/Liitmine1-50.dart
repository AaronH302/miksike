...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      home: PageFourthythree(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class PageFourthythree extends StatefulWidget {
  const PageFourthythree({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageFourthythree> {
        ...
        children: <Widget>[
          ...
          TextButton(
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const PageFourthythree()),
            ),
            child: Container(
              color: Colors.green,
