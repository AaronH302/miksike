...
class PageFourthytwo extends StatefulWidget {
  const PageFourthytwo({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageFourthytwo> {
        ...
        children: <Widget>[
          ...
          TextButton(
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const PageFourthytwo()),
            ),
            child: Container(
              color: Colors.green,
