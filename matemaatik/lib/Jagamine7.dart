...
class PageThirdytwo extends StatefulWidget {
  const PageThirdytwo({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageThirdytwo> {
...
List<Map<String, Object>> _generateQuestions() {
  ...
  for (int i = 1; i <= 10; i++) {
    int divisor = 7; // Add 1 to ensure non-zero values
