...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      home: PageThirdythree(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class PageThirdythree extends StatefulWidget {
  const PageThirdythree({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageThirdythree> {
...
List<Map<String, Object>> _generateQuestions() {
  ...
  for (int i = 1; i <= 10; i++) {
    int divisor = 8; // Add 1 to ensure non-zero values
