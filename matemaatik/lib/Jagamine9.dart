...
class PageThirdyfour extends StatefulWidget {
  const PageThirdyfour({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageThirdyfour> {
...
List<Map<String, Object>> _generateQuestions() {
  ...
  for (int i = 1; i <= 10; i++) {
    int divisor = 9; // Add 1 to ensure non-zero values
