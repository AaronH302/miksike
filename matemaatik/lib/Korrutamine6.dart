...
class PageEightteen extends StatefulWidget {
  const PageEightteen({Key? key}) : super(key: key);
...
class _MyAppState extends State<PageEightteen> {
...
List<Map<String, Object>> _generateQuestions() {
  ...
  for (int i = 1; i <= 10; i++) {
    int num1 = 6; // Add 1 to ensure non-zero values
